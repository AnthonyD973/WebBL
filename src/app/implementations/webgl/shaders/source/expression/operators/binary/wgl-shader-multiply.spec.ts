...
import { WglShaderMultiply } from './wgl-shader-multiply';
...
describe(WglShaderMultiply.name, () => {
    ...
    it('should be created', () => {
        ...
        const operation = new WglShaderMultiply(bTrueLeft, bTrueRight);
    ...
    it('should not be created with invalid types', () => {
        ...
        testCases.forEach((testCase, index) => {
            expect(() => new WglShaderMultiply(testCase.lhs, testCase.rhs)).toThrow();
        });
    });
    ...
    describe('parse', () => {
        ...
        it('should produce valid results with valid types', () => {
            const testCases = [
                ...
                {lhs: s.bTrue, rhs: s.m32},
                {lhs: s.bTrue, rhs: s.v2},
                {lhs: s.bTrue, rhs: s.v3},
                {lhs: s.bTrue, rhs: s.v4},
            ...
            testCases.forEach((testCase, index) => {
                const operation = new WglShaderMultiply(testCase.lhs, testCase.rhs);
