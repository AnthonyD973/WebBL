...
import { WglShaderLogicalOr } from './wgl-shader-logical-or';
...
describe(WglShaderLogicalOr.name, () => {
    ...
    it('should not be created with invalid types', () => {
        ...
        testCases.forEach((testCase, index) => {
            expect(() => new WglShaderLogicalOr(testCase.lhs, testCase.rhs)).toThrow();
        });
    });
    ...
    describe('parse', () => {
        ...
        it('should produce valid results with valid types', () => {
            ...
            testCases.forEach((testCase, index) => {
                const operation = new WglShaderLogicalOr(testCase.lhs, testCase.rhs);
