...
import { WglShaderMultiplyVisitorDispatcher } from './visitor-dispatchers/wgl-shader-multiply-visitor-dispatcher';

const OPERATOR = '*';

export class WglShaderMultiply implements ShaderBinaryOperator {
    ...
    protected assertValid(): void {
        const vd = new WglShaderMultiplyVisitorDispatcher();
