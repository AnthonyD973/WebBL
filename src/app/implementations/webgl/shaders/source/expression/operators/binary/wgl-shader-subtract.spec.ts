...
import { WglShaderSubtract } from './wgl-shader-subtract';
...
describe(WglShaderSubtract.name, () => {
    ...
    it('should not be created with invalid types', () => {
        ...
        testCases.forEach((testCase, index) => {
            expect(() => new WglShaderSubtract(testCase.lhs, testCase.rhs)).toThrow();
        });
    });
    ...
    describe('parse', () => {
        ...
        it('should produce valid results with valid types', () => {
            ...
            testCases.forEach((testCase, index) => {
                const operation = new WglShaderSubtract(testCase.lhs, testCase.rhs);
