...
import { WglShaderBitwiseXor } from './wgl-shader-bitwise-xor';
...
describe(WglShaderBitwiseXor.name, () => {
    ...
    it('should be created', () => {
        ...
        const operation = new WglShaderBitwiseXor(bTrueLeft, bTrueRight);
    ...
    it('should not be created with invalid types', () => {
        ...
        testCases.forEach((testCase, index) => {
            expect(() => new WglShaderBitwiseXor(testCase.lhs, testCase.rhs)).toThrow();
        });
    });
    ...
    describe('parse', () => {
        ...
        it('should produce valid results with valid types', () => {
            ...
            testCases.forEach((testCase, index) => {
                const operation = new WglShaderBitwiseXor(testCase.lhs, testCase.rhs);
