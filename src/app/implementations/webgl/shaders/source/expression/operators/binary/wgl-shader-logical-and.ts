...
import { WglShaderLogicalAndVisitorDispatcher } from './visitor-dispatchers/wgl-shader-logical-and-visitor-dispatcher';

const OPERATOR = '&&';

export class WglShaderLogicalAnd implements ShaderBinaryOperator {
    ...
    protected assertValid(): void {
        const vd = new WglShaderLogicalAndVisitorDispatcher();
