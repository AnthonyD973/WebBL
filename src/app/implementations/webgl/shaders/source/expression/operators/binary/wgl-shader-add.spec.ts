...
import { WglShaderAdd } from './wgl-shader-add';
...
describe(WglShaderAdd.name, () => {
    ...
    it('should be created', () => {
        ...
        const operation = new WglShaderAdd(bTrueLeft, bTrueRight);
    ...
    describe('parse', () => {
        ...
        it('should produce valid results with valid types', () => {
            ...
            testCases.forEach((testCase, index) => {
                const operation = new WglShaderAdd(testCase.lhs, testCase.rhs);
