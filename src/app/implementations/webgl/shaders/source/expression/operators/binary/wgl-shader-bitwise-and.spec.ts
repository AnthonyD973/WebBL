...
import { WglShaderBitwiseAnd } from './wgl-shader-bitwise-and';
...
describe(WglShaderBitwiseAnd.name, () => {
    ...
    it('should be created', () => {
        ...
        const operation = new WglShaderBitwiseAnd(bTrueLeft, bTrueRight);
    ...
    it('should not be created with invalid types', () => {
        ...
        testCases.forEach((testCase, index) => {
            expect(() => new WglShaderBitwiseAnd(testCase.lhs, testCase.rhs)).toThrow();
        });
    });
    ...
    describe('parse', () => {
        ...
        it('should produce valid results with valid types', () => {
            ...
            testCases.forEach((testCase, index) => {
                const operation = new WglShaderBitwiseAnd(testCase.lhs, testCase.rhs);
