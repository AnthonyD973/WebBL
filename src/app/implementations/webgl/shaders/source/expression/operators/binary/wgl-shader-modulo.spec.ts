...
import { WglShaderModulo } from './wgl-shader-modulo';
...
describe(WglShaderModulo.name, () => {
    ...
    it('should be created', () => {
        ...
        const operation = new WglShaderModulo(bTrueLeft, bTrueRight);
    ...
    it('should not be created with invalid types', () => {
        ...
        testCases.forEach((testCase, index) => {
            expect(() => new WglShaderModulo(testCase.lhs, testCase.rhs)).toThrow();
        });
    });
    ...
    describe('parse', () => {
        ...
        it('should produce valid results with valid types', () => {
            ...
            testCases.forEach((testCase, index) => {
                const operation = new WglShaderModulo(testCase.lhs, testCase.rhs);
