...
import { WglShaderBitwiseOrVisitorDispatcher } from './visitor-dispatchers/wgl-shader-bitwise-or-visitor-dispatcher';

const OPERATOR = '|';

export class WglShaderBitwiseOr implements ShaderBinaryOperator {
    ...
    protected assertValid(): void {
        const vd = new WglShaderBitwiseOrVisitorDispatcher();
