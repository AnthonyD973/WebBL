...
import { WglShaderLogicalOrVisitorDispatcher } from './wgl-shader-logical-or-visitor-dispatcher';
...
describe(WglShaderLogicalOrVisitorDispatcher.name, () => {

    beforeEach(() => TestBed.configureTestingModule({
        providers: [
            WglShaderLogicalOrVisitorDispatcher
        ]
    }));

    let vd: WglShaderLogicalOrVisitorDispatcher;
    let s: WglShaderLiteralSamples;

    beforeEach(inject([WglShaderLogicalOrVisitorDispatcher], (injVd) => {
        vd = injVd;
