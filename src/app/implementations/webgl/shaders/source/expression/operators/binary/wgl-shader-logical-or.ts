...
import { WglShaderLogicalOrVisitorDispatcher } from './visitor-dispatchers/wgl-shader-logical-or-visitor-dispatcher';

const OPERATOR = '||';

export class WglShaderLogicalOr implements ShaderBinaryOperator {
    ...
    protected assertValid(): void {
        const vd = new WglShaderLogicalOrVisitorDispatcher();
